...
class SELector:
    ...
    def __init__(self, rseed=None, unlabeled_sub=0.5, no_types=False, type_remapping=None):
        ...
        # Iperparametri        
        random.seed(rseed) # random seed controlla la riproducibilità dei risultati      
        ...
        self.type_remapping = type_remapping  # Riassegna i tipi in base ad un mapping (per variare la specificità) 
